...
pause
echo Flash
avrdude -c avrispmkii -p atmega2560 -U flash:w:apm_flash.hex
echo    eeprom
pause
avrdude -c avrispmkii -p atmega2560 -U eeprom:w:apm_eeprom.hex
echo   hfuse
pause
avrdude -c avrispmkii -p atmega2560 -U hfuse:w:apm_hfuse.hex
echo   lfuse
pause
avrdude -c avrispmkii -p atmega2560 -U lfuse:w:apm_lfuse.hex
echo    efuse
pause
avrdude -c avrispmkii -p atmega2560 -U efuse:w:apm_efuse.hex
