...
export class HomePage {
   ...
   // this is handling of selection, only this need to be change out of anything most of the time
    ...
    changeFlightMode(flightMode) {
        ...
        this.serial.write(ins_str).then(() => {this.overlay.drawText(350,240,"flightMode updated("+flightMode+")"); this.flighModeupdated=true;}).catch(()=>{this.flighModeupdated=false;});
    }
